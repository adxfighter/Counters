...
<head>
    <title>Выбор счетчиика для вывода списка</title>
</head>
<body>
<h2>Выберите счетчик для вывода списка показаний</h2>
<form:form method="POST" action="deleteData">
    <table>
        <tr>
