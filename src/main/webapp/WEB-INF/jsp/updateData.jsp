...
<head>
    ...
    <title>Список показаний счетчика для обновления информации об оплате</title>
...
<h2>${counter_name}</h2>
<form:form method="POST" action="updateDataInfo">
...
<br>
<a href="update">Вернуться к выбору счетчика</a>
<br><br>
